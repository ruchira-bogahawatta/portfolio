...
const Hero = () => {
  return (
    <>
      <section name="hero" className="w-full p-5 bg-backgroundColor h-screen">
        <div className="flex flex-col md:flex-row justify-center items-center h-full gap-3 sm:gap-5 md:gap-10 md:px-10">
          ...
          <div className="flex flex-col text-center md:w-[50%] md:text-left">
            ...
            <p className="text-primaryBlack font-normal text-center md:text-left text-sm sm:text-lg px-5 sm:px-10 md:px-0 text-opacity-50">
              A passionate Full-Stack Developer fueled by self-motivation and
